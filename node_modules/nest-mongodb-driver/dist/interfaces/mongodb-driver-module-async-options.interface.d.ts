...
export interface MongoDbDriverModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
    name?: string;
    inject?: any[];
    useClass?: Type<MongoDbDriverOptionsFactory>;
    useExisting?: Type<MongoDbDriverOptionsFactory>;
    useFactory?: (...args: any[]) => Promise<MongoDbDriverModuleOptions> | MongoDbDriverModuleOptions;
}
